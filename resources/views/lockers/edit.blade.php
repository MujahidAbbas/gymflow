...
@endslot
@slot('title')
    Edit Locker: {{ $locker->locker_number }}
@endslot
@endcomponent
                ...
                <form action="{{ route('lockers.update', $locker->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('location') is-invalid @enderror" 
                                       id="location" name="location" value="{{ old('location', $locker->location) }}" placeholder="e.g., Ground Floor - East Wing">
                                @error('location')
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('monthly_fee') is-invalid @enderror" 
                                       id="monthly_fee" name="monthly_fee" value="{{ old('monthly_fee', $locker->monthly_fee) }}" 
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="notes" name="notes" rows="3">{{ old('notes', $locker->notes) }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-end">
                        ...
                        <button type="submit" class="btn btn-success">
                            <i class="ri-save-line me-1"></i> Update Locker
                        </button>
                    </div>
                </form>
            </div>
