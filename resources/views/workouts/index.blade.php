    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Workout Plans</h4>
                <div class="flex-shrink-0">
                    <a href="{{ route('workouts.today') }}" class="btn btn-info btn-sm me-2">
                        <i class="ri-calendar-check-line align-middle me-1"></i> Today's Workouts
                    </a>
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-2">
                        <input type="text" name="search_value" class="form-control" placeholder="Search workouts...">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-2">
                        <a href="{{route('workouts.index')}}" class="btn btn-secondary w-100">
